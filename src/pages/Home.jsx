...
/** ===== Local DB helpers (same shape as your HTML version) ===== */
const LS_KEY = "gt_v3";
...
const browserId =
  localStorage.gtBrowserId || (localStorage.gtBrowserId = Math.random().toString(36).slice(2));
...
export default function Home() {
  ...
  // Ensure selected gripe id exists
  useEffect(() => {
  ...
  const selected = useMemo(
    () => db.gripes.find((g) => g.id === db.selectedId) || null,
    [db]
  );
      ...
      <div className="ring">
        ...
        <div className="card" id="homeLeft">
          ...
          <div className="voteRow">
            ...
            <button className="btn" id="voteL" onClick={() => selected && vote(selected.id, "L")}>
              VOTE
            </button>
          </div>
        </div>
        ...
        <div className="card" id="homeRight">
          ...
          <div className="voteRow">
            ...
            <button className="btn neon" id="voteR" onClick={() => selected && vote(selected.id, "R")}>
              VOTE
            </button>
          </div>
        </div>
